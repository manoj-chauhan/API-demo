...
public class BenefitPlans {
    ...
    private static final String urlTemplate = Constants.ENV_BASE_URL_ACCOUNT + "/profile/%s/configuration/benefitPlan/search?take=100&skip=0&orderBy=name&orderDirection=ASC";
